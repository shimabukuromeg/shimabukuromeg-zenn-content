...
# NestJSとデコレーター
- NestJSは、デコレーターの言語機能を中心にして作られて、デコレーターがたくさん使われています。デコレーターのドキュメントをひととおり眺めてみたので、改めてNestJSのコードを簡単に見てみました。
...
- NestJSに限らず、デコレーターが採用されてるるライブラリはたくさんあると思うので、ちゃんと使い方を理解したら、便利そうで良さそうな機能だと思いました。
